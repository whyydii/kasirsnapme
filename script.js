// ... (data item tetap sama, tidak perlu diubah)
...
[...catalogItems, ...addonItems, ...minumanItems, ...snackItems].forEach(item => {
    if (catalogItems.includes(item)) createItemInput(item, containerCatalog);
    else if (addonItems.includes(item)) createItemInput(item, containerAddon);
    else if (minumanItems.includes(item)) createItemInput(item, containerMinuman);
    else if (snackItems.includes(item)) createItemInput(item, containerSnack);
});
